...
# 安装xc_cdn.sh
cp /root/pear/init/xc_cdn.sh /etc/init.d/
chmod 755 /etc/init.d/xc_cdn.sh
ln -sf /etc/init.d/xc_cdn.sh /etc/init.d/openfog.sh

# 安装frpc.sh
cp /root/pear/init/frpc.sh /etc/init.d/
chmod 755 /etc/init.d/frpc.sh
